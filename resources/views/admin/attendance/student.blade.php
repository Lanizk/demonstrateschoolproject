                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <label style="margin: right 10px;">
                                                                        <input value="1" type="radio" id="{{$value->id}}" class="SaveAttendance" name="attendance {{$value->id}}">Present</label>
                                                                    <label style="margin: right 10px;">
                                                                        <input value="2" type="radio" id="{{$value->id}}" class="SaveAttendance" name="attendance {{$value->id}}">Late</label>
                                                                    <label style="margin: right 10px;">
                                                                        <input value="3" type="radio" id="{{$value->id}}" class="SaveAttendance" name="attendance {{$value->id}}">Absent</label>
                                                                    <label >
                                                                        <input value="4" type="radio" id="{{$value->id}}" class="SaveAttendance" name="attendance {{$value->id}}">Half Day</label>
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                            @endif
