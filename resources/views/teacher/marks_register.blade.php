                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select class="form-control" name="exam_id">
                                                    ...
                                                    @foreach ($getExam as $exam)
                                                                                <option {{(Request::get('exam_id') == $exam->exam_id) ? 'selected' : ''}} value="{{$exam->exam_id}}">{{$exam->exam_name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-md-3">
                                                ...
                                                <select class="form-control" name="class_id">
                                                    ...
                                                    @foreach ($getClass as $class)
                                                                                        <option {{(Request::get('class_id') == $class->class_id) ? 'selected' : ''}} value="{{$class->class_id}}">{{$class->class_name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                @foreach ($getSubject as $subject)
                                                                                                                                                                                        ...
                                                                                                                                                                                        <td>
                                                                                                                                                                                            <div style="margin-bottom: 10px;">
                                                                                                                                                                                                Class Work
                                                                                                                                                                                                <input type="hidden" name="mark[{{$i}}][full_marks]"
                                                                                                                                                                                                    value="{{$subject->full_marks}}">
                                                                                                                                                                                                <input type="hidden" name="mark[{{$i}}][passing_mark]"
                                                                                                                                                ...
                                                                                                                                                @endforeach
                                                                                                                                                    ...
                                                                                                                                                    @if(!empty($totalStudentMark))
                                                                                                                                                                                                <br>
                                                                                                                                                                                                <br>
                                                                                                                                                                                                <b>Subject Total Mark:</b>{{$totalFullMarks}}
                                                                                                                                                                                                <br>
                                                                                                                                                                                                <b>Subject Passing Mark:</b>{{$totalPassingMark}}
                                                                                                                                                                                                <br>
